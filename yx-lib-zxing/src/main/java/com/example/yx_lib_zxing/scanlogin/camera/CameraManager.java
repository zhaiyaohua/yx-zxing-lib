...
package com.example.yx_lib_zxing.scanlogin.camera;
...
import com.example.yx_lib_zxing.scanlogin.android.PlanarYUVLuminanceSource;

import java.io.IOException;

import static com.example.yx_lib_zxing.scanlogin.android.ScanConstants.KEY_REVERSE_IMAGE;
...
public final class CameraManager {
    ...
    public Camera getCameraNotStatic() {
        return camera;
    }
    ...
    public Rect getFramingRect() {
        if (framingRect == null) {
            ...
            int topOffset = (screenResolution.x - height - dp2px(90)) / 2;
