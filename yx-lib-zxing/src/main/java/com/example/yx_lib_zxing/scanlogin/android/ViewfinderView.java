...
public final class ViewfinderView extends View {
    ...
    private Paint framePaint, framePaintWhite;
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        framePaintWhite = new Paint(Paint.ANTI_ALIAS_FLAG);
        textPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        Resources resources = getResources();
        maskColor = resources.getColor(R.color.c13_a40);
        resultColor = resources.getColor(R.color.c13);
        frameColor = resources.getColor(R.color.b24);
        resultPointColor = resources.getColor(R.color.b24);
        ...
        //白色
        framePaintWhite.setColor(resources.getColor(R.color.c01));
        framePaintWhite.setStyle(Paint.Style.STROKE);
        framePaintWhite.setStrokeWidth(1);
        //textPaint
        textHint = resources.getString(R.string.scan_tips);
        textPaint.setColor(getResources().getColor(R.color.c01));
        textPaint.setTextSize(getResources().getDimension(R.dimen.T04));
//        textPaint.setTextSize(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PX, TEXT_SIZE * density, context.getResources().getDisplayMetrics()));
        ...
        //flashLight
        flashLightBitmap = ((BitmapDrawable) resources.getDrawable(R.drawable.scan_close_flashlight)).getBitmap();
        openFlashLightBitmap = ((BitmapDrawable) resources.getDrawable(R.drawable.scan_open_flashlight)).getBitmap();
        scanLineBitmap = ((BitmapDrawable) resources.getDrawable(R.drawable.zxing_scan_line1)).getBitmap();
        flashRect = new Rect();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //绘制frame边框
        canvas.drawRect(frame, framePaintWhite);
        ...
        if (resultBitmap != null) {
            ...
            if (!ScanConstants.isWeakLight || isOpenFlashLight) {
                //绘制中间的线
                slideTop += SPEED;
